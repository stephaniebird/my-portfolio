      ...
      <main className="bg-background">
        <div className="max-w-[820px] mx-auto px-4 md:px-8 pt-12 md:pt-16 pb-20">
          ...
          <div className="mb-8">
            ...
            <p className="font-sans text-[11px] font-bold uppercase tracking-[1.6px] text-foreground mb-5">
              Senior Product Designer&nbsp;&nbsp;|&nbsp;&nbsp;Design Systems&nbsp;&nbsp;|&nbsp;&nbsp;Desktop SaaS &amp; Enterprise Software
            </p>
            <p className="font-sans text-[14px] font-normal leading-relaxed text-foreground max-w-[540px] mb-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <a href="tel:8013105394" className="font-sans text-[11px] font-bold uppercase tracking-[1.4px] text-foreground hover:text-[#FF2900] transition-colors">801.310.5394</a>
              <span className="text-muted select-none">|</span>
              <a
                href="mailto:stephaniejae.design@gmail.com"
                className="font-sans text-[11px] font-bold uppercase tracking-[1.4px] text-foreground hover:text-[#FF2900] transition-colors"
              >
              ...
              <div key={job.company}>
                <div className="grid gap-4 md:gap-8 md:grid-cols-[188px_1fr]">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="font-sans text-[11px] font-bold uppercase tracking-[1.2px] text-foreground mb-2">
                      {job.title}
                    </p>
                    <p className="font-sans text-[12px] text-foreground leading-snug">{job.location}</p>
                    <p className="font-sans text-[12px] text-foreground leading-snug uppercase tracking-[0.6px]">
                      {job.dates}
                    </p>
                  </div>
                  {/* Right */}
                  <ul className="flex flex-col gap-[10px] pt-1">
                    {job.bullets.map((bullet, j) => (
                      <li key={j} className="flex gap-3 items-start">
                        ...
                        <span className="font-sans text-[14px] font-normal leading-relaxed text-foreground">
                          {bullet}
                        </span>
                      </li>
                    ))}
          ...
          <div className="grid gap-4 md:gap-8 mb-8 md:grid-cols-[188px_1fr]">
            ...
            <div className="flex flex-col gap-3">
              {skills.map((s) => (
                <p key={s.label} className="font-sans text-[14px] text-foreground leading-relaxed">
          ...
          <div className="grid gap-4 md:gap-8 md:grid-cols-[188px_1fr]">
            ...
            <div className="flex flex-col gap-2">
              {education.map((e) => (
                <p key={e.school} className="font-sans text-[14px] text-foreground leading-relaxed">
